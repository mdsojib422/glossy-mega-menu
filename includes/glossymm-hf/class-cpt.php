...
namespace GlossyMM\Glossymm_HF {
    ...
    class Cpt {
        ...
        public function __construct() {
            ...
            add_action( 'save_post', [$this, 'glossymm_hf_save_meta'] );
        ...
        public function glossymm_hf_save_meta( $post_id ) {
            ...
            if ( isset( $existting_data[$glossymm_template_type] ) && in_array( $glossymm_location, $existting_data[$glossymm_template_type] ) ) {
                ...
                set_transient( 'glossymm_post_validation_error', $notice_info, 30 );
                add_filter( 'redirect_post_location', [$this, 'glossy_remove_default_updated_message'], 10, 2 );
                return;
            }
            if ( isset( $_POST['glossymm-target-location-select'] ) ) {
                ...
                //Initially Save Enabled
                add_post_meta( $post_id, "glossymm_enabled_template", 1 );
            }
